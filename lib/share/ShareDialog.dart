                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: List.generate(
                          ShareDialog().sharebuttonTitles.length, (index) {
                        return Container(
                          child: ShareDialog()._buttonWidget(
                              context,
                              path,
                              ShareDialog().sharebuttonTitles[index],
                              ShareDialog().sharebuttonImages[index],
                              index),
                        );
                      }).toList(),
                    ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: List.generate(
                          ShareDialog().buttonTitles.length, (index) {
                        return Container(
                          child: ShareDialog()._buttonWidget(
                              context,
                              "",
                              ShareDialog().buttonTitles[index],
                              ShareDialog().buttonImages[index],
                              index),
                        );
                      }).toList(),
                    ),
        ...
        switch (index) {
          ...
          case 2: //新浪微博
            FlutterClipboard.copy(text).then(
                    (value) =>
                    ToastUtils.showToast('复制成功，打开微博APP分享'));
            _dismiss(context);
            break;
          case 3: //复制链接
