...
class HelpContentPage extends StatefulWidget {
  final Map data;
  const HelpContentPage(this.data, {Key? key,}) : super(key: key);
...
const Map<String, List> helpData = {
  'hot': [
    ...
    },
    {
      'title': '一次买多个商品怎么做',
      'content':
      '若要买的商品已加入购物车，请清空购物车。清空后，重新通过$APP_NAME领券后一一加入购物车，最后再一起付款。'
    },
    {
    ...
    },
    {
      'title': '怎么联系客服',
      'content':
          '首页点击右下角【我的】，进入个人中心，点击【在线客服】，就可以联系微信客服了，需要安装微信。'
    },
    {
      'title': '如何查看商品是否有优惠券',
      'content':
    ...
    },
    {
      'title': '优惠券的用途是什么',
      'content':
      '优惠券可抵扣部分现金进行消费。例如，使用30元的优惠券，购买商品时就可以省30元。'
    },
    {
      'title': '如何领取优惠券',
      'content':
      '点击商品进入详情页，点击【立即购买】或【领券购买】，在粉丝福利购页面点击【立即领券】，即领券成功。'
    },
    {
      'title': '如何使用优惠券下单',
      'content':
      '点击商品进入详情页，领券成功后自动跳转至淘宝商品详情页，点击立即购买，下单自动使用优惠券哦。'
    },
    {
  ...
  'gongneng':[
    {
      ...
      'content':
    '点击商品进入详情页，点击左下角【收藏】，即可收藏成功。查看收藏商品，在首页点击右下角【我的】→在【我的收藏】中进行查看。'
    },
    ],
  'order':[
    {
  ...
  'youhui':[
    {
      ...
      'content':
      '遇到这种情况，请先检查一下自己的网络状况。也可能是遇到了神秘bug，请稍候再尝试哦。'
    },
    {
