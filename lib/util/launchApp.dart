...
class LaunchApp {
      ...
      if(Global.isIOS()) {
        //如果是淘宝调用百川，不是继续愿流程
          if(data['package'] == taobao) {
            FlutterAlibc.openByUrl(url: url,
  ...
  static String? parseUrl(String url) {
    if (url.contains("taobao.com") || url.contains("tb.cn")) {
      ...
      //如果是京粉连接不阻止
      if (url.startsWith('https://jingfen.jd.com')||
          url.startsWith('https://h5.m.jd.com')) {
        return null;
      }
  ...
  static Map getPackageName(String url) {
    ...
    } else if (url.contains("mobile.yangkeduo.com") ||
        url.contains("pinduoduo.com")) {
