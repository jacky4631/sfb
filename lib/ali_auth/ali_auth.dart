...
class AliAuthPage extends StatefulWidget {
  const AliAuthPage({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return AliAuthPageState();
  }
}

class AliAuthPageState extends State<AliAuthPage> with WidgetsBindingObserver {
  String status = "初始化中...";
  ...
  void initState() {
    ...
    setState(() {
      ...
      screenHeight = (PlatformDispatcher.instance.views.first.physicalSize.height /
              PlatformDispatcher.instance.views.first.devicePixelRatio)
          .floor();
      dialogWidth = (PlatformDispatcher.instance.views.first.physicalSize.width /
              PlatformDispatcher.instance.views.first.devicePixelRatio *
              0.8)
          .floor();
    ...
    AliAuth.loginListen(onEvent: (onEvent) {
      ...
      // 自己关闭授权页面
      // if (onEvent["code"] == "700005" || onEvent["code"] == "700010") {
      //   AliAuth.quitPage();
      // }
      ...
      // Fluttertoast.showToast(msg: onEvent['msg'] ?? "");
  ...
  AliAuthModel getFullPortPrivacyConfig({bool isDelay = false}) {
    ...
    return AliAuthModel(androidSk, iosSk,
        ...
        protocolThreeURL: "https://a.app.qq.com/o/simple.jsp?pkgname=com.civiccloud.master&fromcase=40002",
        protocolCustomColor: "#026ED2",
        protocolColor: "#bfbfbf",
        protocolLayoutGravity: Gravity.centerHorizntal,
