...
class AliAuthWebPage extends StatefulWidget {
  const AliAuthWebPage({Key? key}) : super(key: key);
...
class MyHomePageWebState extends State<AliAuthWebPage> with WidgetsBindingObserver {
        ...
        body: Center(
          child: ListView(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  AliAuth.checkAuthAvailable(accessToken, jwtToken, success: (status) {
                    if (kDebugMode) {
                      print(status);
                    }
