...
//    shanYanUIConfig.ios.setAuthWindowCornerRadius = 10;
   ...
   shanYanUIConfig.ios.layOutPortrait.setPrivacyHeight = 50;
    ...
    ShanYanCustomWidgetIOS buttonWidgetiOS =
        ShanYanCustomWidgetIOS(btnOtherLogin, ShanYanCustomWidgetType.Button);
...
//    buttonWidgetiOS.right = 50;
    ...
    ConfigPrivacyBean configPrivacyBean1 = ConfigPrivacyBean("用户服务协议",
        Global.userUrl);
    configPrivacyBean1.color = "#FC5434";
    configPrivacyBean1.midStr = "和";
    configPrivacyBean1.title = "用户服务协议";
    ConfigPrivacyBean configPrivacyBean2 = ConfigPrivacyBean("$APP_NAME隐私政策",
        Global.privacyUrl);
    ...
    ShanYanCustomWidget buttonWidgetAndroid =
        ShanYanCustomWidget(btnOtherLogin, ShanYanCustomWidgetType.Button);
